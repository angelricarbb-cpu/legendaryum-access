            ...
            <div id="how-it-works" className="mb-16">
              ...
              <div className="grid md:grid-cols-4 gap-6">
                {[
                  ...
                  { n: 3, icon: TrendingUp, title: "Tu comunidad gana", desc: "Tus seguidores acceden con descuentos." },
                  { n: 4, icon: Wallet, title: "Tú ganas", desc: "Ingresos recurrentes durante 12 meses." },
                ].map((s) => (
