...
const mockCampaigns: RankingCampaign[] = [
  ...
  // Premium campaign where user already joined (has played) - shows Join Now in premium colors
  {
    id: "2d",
    title: "Premium Speed Masters",
    logo: "",
    brandName: "PREMIUM RACING",
    topPlayers: [
      { position: 1, username: "@SpeedMaster", points: 450000 },
      { position: 2, username: "@RacingPro", points: 380000 },
      { position: 3, username: "@TurboKing", points: 320000 },
    ],
    myPosition: null,
    myPoints: 0,
    totalPlayers: 500,
    ...
    bonusLevel: {
      gamesRequired: 5,
      reward: "25% Premium Code",
      rewardType: "code",
    },
    specialReward: {
      gamesRequired: 15,
      reward: "$120 Amazon Gift Card",
      rewardType: "item",
    },
  },
  // FREE tournament - shows Join Now in normal colors
  {
    id: "2e",
    title: "Open Community Cup",
    logo: "",
    brandName: "COMMUNITY GAMING",
    topPlayers: [
      { position: 1, username: "@FreePlayer", points: 180000 },
      { position: 2, username: "@CommunityHero", points: 150000 },
      { position: 3, username: "@OpenGamer", points: 120000 },
    ],
    myPosition: null,
    myPoints: 0,
    totalPlayers: 2500,
