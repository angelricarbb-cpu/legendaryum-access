...
import { Trophy, Medal, Award, Info, Gamepad2, Users, Clock, Lock, Crown, Ticket } from "lucide-react";
...
interface EventCampaignCardProps {
  ...
  onUpgrade?: () => void;
  onBuyTicket: (campaignId: string) => void;
}
      ...
      <div className="relative aspect-[4/3] bg-gradient-to-br from-primary/20 to-accent/20 overflow-hidden">
        ...
        <div className="absolute top-2 left-2 right-2 flex justify-between items-start">
          <div className="flex gap-1.5">
            ...
            <Badge className="text-[10px] px-2 py-0.5 bg-purple-500 hover:bg-purple-500 text-white">
        ...
        {/* Ticket status badge */}
        {campaign.hasTicket && campaign.status === "coming_soon" && (
          <div className="absolute bottom-2 left-2 bg-green-500/90 backdrop-blur-sm rounded-full px-2 py-1 flex items-center gap-1">
            <Ticket className="h-3 w-3 text-white" />
            <span className="text-[10px] font-medium text-white">Ticket Ready</span>
          </div>
        )}
      </div>
          ...
          <>
            {isPlanLocked ? (
              ...
              <div className="space-y-2">
                ...
                <div className="w-full text-center py-1.5 bg-green-500/20 rounded-lg border border-green-500/30">
                  <div className="flex items-center justify-center gap-1.5 text-xs font-medium text-green-500">
...
export default EventCampaignCard;
